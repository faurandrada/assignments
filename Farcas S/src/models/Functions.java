...
public class Functions {
	 ...
	 *         coefficients
	 */
	public static Polynomial[] divide(Polynomial p1, Polynomial p2) throws DivideByZeroException {

		if (p2.getCoefficients().equals(new CoefficientReal[] { new CoefficientReal(0) })) {
